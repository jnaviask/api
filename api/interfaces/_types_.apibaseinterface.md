...
*Defined in [types.ts:164](https://github.com/polkadot-js/api/blob/4a35380/packages/api/src/types.ts#L164)*
...
*Defined in [types.ts:165](https://github.com/polkadot-js/api/blob/4a35380/packages/api/src/types.ts#L165)*
...
*Defined in [types.ts:162](https://github.com/polkadot-js/api/blob/4a35380/packages/api/src/types.ts#L162)*
