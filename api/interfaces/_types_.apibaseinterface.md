...
*Defined in [types.ts:166](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/types.ts#L166)*
...
*Defined in [types.ts:167](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/types.ts#L167)*
...
*Defined in [types.ts:164](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/types.ts#L164)*
