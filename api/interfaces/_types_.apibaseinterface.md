...
*Defined in [types.ts:188](https://github.com/polkadot-js/api/blob/0f3a745/packages/api/src/types.ts#L188)*
...
*Defined in [types.ts:189](https://github.com/polkadot-js/api/blob/0f3a745/packages/api/src/types.ts#L189)*
...
*Defined in [types.ts:186](https://github.com/polkadot-js/api/blob/0f3a745/packages/api/src/types.ts#L186)*
