...
*Defined in [types.ts:189](https://github.com/polkadot-js/api/blob/55cb55a/packages/api/src/types.ts#L189)*
...
*Defined in [types.ts:190](https://github.com/polkadot-js/api/blob/55cb55a/packages/api/src/types.ts#L190)*
...
*Defined in [types.ts:187](https://github.com/polkadot-js/api/blob/55cb55a/packages/api/src/types.ts#L187)*
