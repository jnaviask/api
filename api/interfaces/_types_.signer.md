...
*Defined in [types.ts:226](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api/src/types.ts#L226)*
...
*Defined in [types.ts:221](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api/src/types.ts#L221)*
