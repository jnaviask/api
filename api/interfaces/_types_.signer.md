...
*Defined in [types.ts:205](https://github.com/polkadot-js/api/blob/bb38db5/packages/api/src/types.ts#L205)*
...
*Defined in [types.ts:200](https://github.com/polkadot-js/api/blob/bb38db5/packages/api/src/types.ts#L200)*
