...
*Defined in [types.ts:201](https://github.com/polkadot-js/api/blob/f8f05ba/packages/api/src/types.ts#L201)*
...
*Defined in [types.ts:196](https://github.com/polkadot-js/api/blob/f8f05ba/packages/api/src/types.ts#L196)*
