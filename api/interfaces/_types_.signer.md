...
*Defined in [types.ts:177](https://github.com/polkadot-js/api/blob/cfa27ff/packages/api/src/types.ts#L177)*
...
*Defined in [types.ts:172](https://github.com/polkadot-js/api/blob/cfa27ff/packages/api/src/types.ts#L172)*
