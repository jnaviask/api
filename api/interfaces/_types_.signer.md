...
*Defined in [types.ts:179](https://github.com/polkadot-js/api/blob/edbae32/packages/api/src/types.ts#L179)*
...
*Defined in [types.ts:174](https://github.com/polkadot-js/api/blob/edbae32/packages/api/src/types.ts#L174)*
