...
*Defined in [types.ts:206](https://github.com/polkadot-js/api/blob/4f9aecc/packages/api/src/types.ts#L206)*
...
*Defined in [types.ts:201](https://github.com/polkadot-js/api/blob/4f9aecc/packages/api/src/types.ts#L201)*
