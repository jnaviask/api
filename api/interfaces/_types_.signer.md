...
*Defined in [types.ts:201](https://github.com/polkadot-js/api/blob/36d7a85/packages/api/src/types.ts#L201)*
...
*Defined in [types.ts:196](https://github.com/polkadot-js/api/blob/36d7a85/packages/api/src/types.ts#L196)*
