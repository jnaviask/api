...
*Defined in [types.ts:177](https://github.com/polkadot-js/api/blob/f2b4a80/packages/api/src/types.ts#L177)*
...
*Defined in [types.ts:172](https://github.com/polkadot-js/api/blob/f2b4a80/packages/api/src/types.ts#L172)*
