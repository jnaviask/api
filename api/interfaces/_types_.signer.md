...
*Defined in [types.ts:177](https://github.com/polkadot-js/api/blob/9b4f42b/packages/api/src/types.ts#L177)*
...
*Defined in [types.ts:172](https://github.com/polkadot-js/api/blob/9b4f42b/packages/api/src/types.ts#L172)*
