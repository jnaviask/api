...
*Defined in [types.ts:201](https://github.com/polkadot-js/api/blob/1e8e0b2/packages/api/src/types.ts#L201)*
...
*Defined in [types.ts:196](https://github.com/polkadot-js/api/blob/1e8e0b2/packages/api/src/types.ts#L196)*
