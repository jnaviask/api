...
*Defined in [types.ts:177](https://github.com/polkadot-js/api/blob/32f17fc/packages/api/src/types.ts#L177)*
...
*Defined in [types.ts:172](https://github.com/polkadot-js/api/blob/32f17fc/packages/api/src/types.ts#L172)*
