...
*Defined in [types.ts:226](https://github.com/polkadot-js/api/blob/d38ccd1/packages/api/src/types.ts#L226)*
...
*Defined in [types.ts:221](https://github.com/polkadot-js/api/blob/d38ccd1/packages/api/src/types.ts#L221)*
