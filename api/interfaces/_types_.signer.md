...
*Defined in [types.ts:205](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/api/src/types.ts#L205)*
...
*Defined in [types.ts:200](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/api/src/types.ts#L200)*
