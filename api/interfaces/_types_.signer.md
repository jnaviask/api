...
*Defined in [types.ts:199](https://github.com/polkadot-js/api/blob/3557657/packages/api/src/types.ts#L199)*
...
*Defined in [types.ts:194](https://github.com/polkadot-js/api/blob/3557657/packages/api/src/types.ts#L194)*
