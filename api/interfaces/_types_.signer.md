...
*Defined in [types.ts:226](https://github.com/polkadot-js/api/blob/4cba24c/packages/api/src/types.ts#L226)*
...
*Defined in [types.ts:221](https://github.com/polkadot-js/api/blob/4cba24c/packages/api/src/types.ts#L221)*
