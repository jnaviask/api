...
*Defined in [types.ts:179](https://github.com/polkadot-js/api/blob/adec070/packages/api/src/types.ts#L179)*
...
*Defined in [types.ts:174](https://github.com/polkadot-js/api/blob/adec070/packages/api/src/types.ts#L174)*
