...
*Defined in [types.ts:179](https://github.com/polkadot-js/api/blob/76a9d73/packages/api/src/types.ts#L179)*
...
*Defined in [types.ts:174](https://github.com/polkadot-js/api/blob/76a9d73/packages/api/src/types.ts#L174)*
