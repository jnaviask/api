...
*Defined in [types.ts:205](https://github.com/polkadot-js/api/blob/f9e8aed/packages/api/src/types.ts#L205)*
...
*Defined in [types.ts:200](https://github.com/polkadot-js/api/blob/f9e8aed/packages/api/src/types.ts#L200)*
