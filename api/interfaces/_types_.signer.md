...
*Defined in [types.ts:177](https://github.com/polkadot-js/api/blob/34ca31c/packages/api/src/types.ts#L177)*
...
*Defined in [types.ts:172](https://github.com/polkadot-js/api/blob/34ca31c/packages/api/src/types.ts#L172)*
