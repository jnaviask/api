...
*Defined in [Base.ts:84](https://github.com/polkadot-js/api/blob/9ba9897/packages/api/src/Base.ts#L84)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/9ba9897/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/9ba9897/packages/api/src/rx/types.ts#L14)*
