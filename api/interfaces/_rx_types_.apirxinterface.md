...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/07ba80b/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/07ba80b/packages/api/src/rx/types.ts#L14)*
