...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/f9e8aed/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/f9e8aed/packages/api/src/rx/types.ts#L14)*
