...
*Defined in [Base.ts:81](https://github.com/polkadot-js/api/blob/6d9699a/packages/api/src/Base.ts#L81)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/6d9699a/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/6d9699a/packages/api/src/rx/types.ts#L14)*
