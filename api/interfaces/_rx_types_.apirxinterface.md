...
*Defined in [Base.ts:84](https://github.com/polkadot-js/api/blob/5a292db/packages/api/src/Base.ts#L84)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/5a292db/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/5a292db/packages/api/src/rx/types.ts#L14)*
