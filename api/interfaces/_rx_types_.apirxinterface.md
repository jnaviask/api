...
*Defined in [Base.ts:83](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/Base.ts#L83)*
...
*Defined in [rx/types.ts:13](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/rx/types.ts#L13)*
...
*Defined in [rx/types.ts:14](https://github.com/polkadot-js/api/blob/7fb1944/packages/api/src/rx/types.ts#L14)*
