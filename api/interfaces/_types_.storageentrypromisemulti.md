...
*Defined in [types.ts:110](https://github.com/polkadot-js/api/blob/8ca4b5a/packages/api/src/types.ts#L110)*
...
*Defined in [types.ts:111](https://github.com/polkadot-js/api/blob/8ca4b5a/packages/api/src/types.ts#L111)*
