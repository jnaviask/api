...
*Defined in [types.ts:119](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api/src/types.ts#L119)*
...
*Defined in [types.ts:120](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api/src/types.ts#L120)*
