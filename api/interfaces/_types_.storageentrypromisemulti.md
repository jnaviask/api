...
*Defined in [types.ts:119](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/types.ts#L119)*
...
*Defined in [types.ts:120](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/types.ts#L120)*
