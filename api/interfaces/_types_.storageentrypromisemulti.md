...
*Defined in [types.ts:110](https://github.com/polkadot-js/api/blob/eec4ca7/packages/api/src/types.ts#L110)*
...
*Defined in [types.ts:111](https://github.com/polkadot-js/api/blob/eec4ca7/packages/api/src/types.ts#L111)*
