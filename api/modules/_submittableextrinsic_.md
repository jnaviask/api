...
*Defined in [SubmittableExtrinsic.ts:28](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api/src/SubmittableExtrinsic.ts#L28)*
...
*Defined in [SubmittableExtrinsic.ts:33](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api/src/SubmittableExtrinsic.ts#L33)*
...
*Defined in [SubmittableExtrinsic.ts:103](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api/src/SubmittableExtrinsic.ts#L103)*
