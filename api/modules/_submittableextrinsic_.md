...
*Defined in [SubmittableExtrinsic.ts:26](https://github.com/polkadot-js/api/blob/68b07eb/packages/api/src/SubmittableExtrinsic.ts#L26)*
...
*Defined in [SubmittableExtrinsic.ts:31](https://github.com/polkadot-js/api/blob/68b07eb/packages/api/src/SubmittableExtrinsic.ts#L31)*
...
*Defined in [SubmittableExtrinsic.ts:84](https://github.com/polkadot-js/api/blob/68b07eb/packages/api/src/SubmittableExtrinsic.ts#L84)*
