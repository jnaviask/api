...
*Defined in [promise/Combinator.ts:9](https://github.com/polkadot-js/api/blob/5a292db/packages/api/src/promise/Combinator.ts#L9)*
...
*Defined in [promise/Combinator.ts:10](https://github.com/polkadot-js/api/blob/5a292db/packages/api/src/promise/Combinator.ts#L10)*
