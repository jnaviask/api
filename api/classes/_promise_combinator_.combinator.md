...
*Defined in [promise/Combinator.ts:22](https://github.com/polkadot-js/api/blob/f9605cd/packages/api/src/promise/Combinator.ts#L22)*
...
*Defined in [promise/Combinator.ts:68](https://github.com/polkadot-js/api/blob/f9605cd/packages/api/src/promise/Combinator.ts#L68)*
