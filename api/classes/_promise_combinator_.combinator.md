...
*Defined in [promise/Combinator.ts:21](https://github.com/polkadot-js/api/blob/b37aebe/packages/api/src/promise/Combinator.ts#L21)*
...
*Defined in [promise/Combinator.ts:67](https://github.com/polkadot-js/api/blob/b37aebe/packages/api/src/promise/Combinator.ts#L67)*
