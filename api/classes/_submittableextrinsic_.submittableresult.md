...
*Defined in [SubmittableExtrinsic.ts:52](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L52)*
...
*Defined in [SubmittableExtrinsic.ts:51](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L51)*
...
*Defined in [SubmittableExtrinsic.ts:59](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L59)*
...
*Defined in [SubmittableExtrinsic.ts:63](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L63)*
...
*Defined in [SubmittableExtrinsic.ts:67](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L67)*
...
*Defined in [SubmittableExtrinsic.ts:74](https://github.com/polkadot-js/api/blob/1a80bde/packages/api/src/SubmittableExtrinsic.ts#L74)*
