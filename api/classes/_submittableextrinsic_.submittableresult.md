...
*Defined in [SubmittableExtrinsic.ts:56](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L56)*
...
*Defined in [SubmittableExtrinsic.ts:54](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L54)*
...
*Defined in [SubmittableExtrinsic.ts:63](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L63)*
...
*Defined in [SubmittableExtrinsic.ts:67](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L67)*
...
*Defined in [SubmittableExtrinsic.ts:71](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L71)*
...
*Defined in [SubmittableExtrinsic.ts:78](https://github.com/polkadot-js/api/blob/f95fb6d/packages/api/src/SubmittableExtrinsic.ts#L78)*
