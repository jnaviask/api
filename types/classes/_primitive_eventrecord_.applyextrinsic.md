...
*__description__*: The [Phase](_primitive_eventrecord_.phase.md) where the extrinsic is applied
...
*Defined in [primitive/U32.ts:14](https://github.com/polkadot-js/api/blob/767891d/packages/types/src/primitive/U32.ts#L14)*
...
*Defined in [codec/UInt.ts:48](https://github.com/polkadot-js/api/blob/767891d/packages/types/src/codec/UInt.ts#L48)*
