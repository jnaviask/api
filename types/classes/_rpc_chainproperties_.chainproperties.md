...
*Defined in [rpc/ChainProperties.ts:16](https://github.com/polkadot-js/api/blob/7e5b09a/packages/types/src/rpc/ChainProperties.ts#L16)*
...
*Defined in [rpc/ChainProperties.ts:23](https://github.com/polkadot-js/api/blob/7e5b09a/packages/types/src/rpc/ChainProperties.ts#L23)*
