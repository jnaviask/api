...
*__description__*: The default contract code hash that is used accross the system. It is a wrapper around [Hash](_primitive_hash_.hash.md), representing a 32-byte blake2b (Substrate) value
...
*Defined in [primitive/H256.ts:15](https://github.com/polkadot-js/api/blob/8f088c3/packages/types/src/primitive/H256.ts#L15)*
...
*Defined in [primitive/H256.ts:23](https://github.com/polkadot-js/api/blob/8f088c3/packages/types/src/primitive/H256.ts#L23)*
