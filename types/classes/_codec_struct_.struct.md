...
* `Map<keyof S, Codec>`
  ...
  * [NewBidder](_type_bidder_.newbidder.md)
  ...
  * [UpwardMessage](_type_upwardmessage_.upwardmessage.md)
...
*Defined in [codec/Struct.ts:31](https://github.com/polkadot-js/api/blob/a3ce867/packages/types/src/codec/Struct.ts#L31)*
