...
*Defined in [types.ts:154](https://github.com/polkadot-js/api/blob/ca53fbc/packages/types/src/types.ts#L154)*
...
*Defined in [types.ts:155](https://github.com/polkadot-js/api/blob/ca53fbc/packages/types/src/types.ts#L155)*