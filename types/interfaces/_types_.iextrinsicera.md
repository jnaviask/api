...
*Defined in [types.ts:154](https://github.com/polkadot-js/api/blob/b77b3db/packages/types/src/types.ts#L154)*
...
*Defined in [types.ts:155](https://github.com/polkadot-js/api/blob/b77b3db/packages/types/src/types.ts#L155)*