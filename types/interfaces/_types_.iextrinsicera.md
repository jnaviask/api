...
*Defined in [types.ts:154](https://github.com/polkadot-js/api/blob/c331cd5/packages/types/src/types.ts#L154)*
...
*Defined in [types.ts:155](https://github.com/polkadot-js/api/blob/c331cd5/packages/types/src/types.ts#L155)*