...
*Defined in [types.ts:142](https://github.com/polkadot-js/api/blob/70dadb8/packages/types/src/types.ts#L142)*
...
*Defined in [types.ts:143](https://github.com/polkadot-js/api/blob/70dadb8/packages/types/src/types.ts#L143)*