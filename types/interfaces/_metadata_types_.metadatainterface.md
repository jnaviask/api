...
*Defined in [Metadata/types.ts:9](https://github.com/polkadot-js/api/blob/4bdbacb/packages/types/src/Metadata/types.ts#L9)*
...
*Defined in [Metadata/types.ts:10](https://github.com/polkadot-js/api/blob/4bdbacb/packages/types/src/Metadata/types.ts#L10)*
