...
*Defined in [Metadata/types.ts:9](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/types/src/Metadata/types.ts#L9)*
...
*Defined in [Metadata/types.ts:10](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/types/src/Metadata/types.ts#L10)*
