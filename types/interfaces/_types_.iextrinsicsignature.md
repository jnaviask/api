...
*Defined in [types.ts:129](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/types/src/types.ts#L129)*
...
*Defined in [types.ts:128](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/types/src/types.ts#L128)*
