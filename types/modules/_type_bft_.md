...
*Defined in [type/Bft.ts:12](https://github.com/polkadot-js/api/blob/db78aeb/packages/types/src/type/Bft.ts#L12)*
...
*Defined in [type/Bft.ts:43](https://github.com/polkadot-js/api/blob/db78aeb/packages/types/src/type/Bft.ts#L43)*
