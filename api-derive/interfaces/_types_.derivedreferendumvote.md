...
*Defined in [types.ts:45](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L45)*
...
*Defined in [types.ts:46](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L46)*
...
*Defined in [types.ts:47](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L47)*
