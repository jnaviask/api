...
*Defined in [types.ts:37](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L37)*
...
*Defined in [types.ts:38](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L38)*
...
*Defined in [types.ts:39](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L39)*
...
*Defined in [types.ts:40](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L40)*
...
*Defined in [types.ts:41](https://github.com/polkadot-js/api/blob/6d5f297/packages/api-derive/src/types.ts#L41)*
