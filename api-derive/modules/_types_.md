...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/ed19ba9/packages/api-derive/src/types.ts#L19)*
...
*Defined in [types.ts:76](https://github.com/polkadot-js/api/blob/ed19ba9/packages/api-derive/src/types.ts#L76)*
