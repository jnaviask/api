...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/35a59ec/packages/api-derive/src/types.ts#L19)*
...
*Defined in [types.ts:74](https://github.com/polkadot-js/api/blob/35a59ec/packages/api-derive/src/types.ts#L74)*
