...
*Defined in [types.ts:19](https://github.com/polkadot-js/api/blob/271691a/packages/api-derive/src/types.ts#L19)*
...
*Defined in [types.ts:76](https://github.com/polkadot-js/api/blob/271691a/packages/api-derive/src/types.ts#L76)*