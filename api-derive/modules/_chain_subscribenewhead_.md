...
*Defined in [chain/subscribeNewHead.ts:13](https://github.com/polkadot-js/api/blob/4a22a43/packages/api-derive/src/chain/subscribeNewHead.ts#L13)*
...
*Defined in [chain/subscribeNewHead.ts:28](https://github.com/polkadot-js/api/blob/4a22a43/packages/api-derive/src/chain/subscribeNewHead.ts#L28)*
