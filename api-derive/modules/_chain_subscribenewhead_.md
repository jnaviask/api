...
*Defined in [chain/subscribeNewHead.ts:12](https://github.com/polkadot-js/api/blob/07ba80b/packages/api-derive/src/chain/subscribeNewHead.ts#L12)*
...
*Defined in [chain/subscribeNewHead.ts:27](https://github.com/polkadot-js/api/blob/07ba80b/packages/api-derive/src/chain/subscribeNewHead.ts#L27)*
