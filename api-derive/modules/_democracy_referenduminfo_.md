...
*Defined in [democracy/referendumInfo.ts:15](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/api-derive/src/democracy/referendumInfo.ts#L15)*
...
*Defined in [democracy/referendumInfo.ts:28](https://github.com/polkadot-js/api/blob/7e1d4cd/packages/api-derive/src/democracy/referendumInfo.ts#L28)*
