...
*Defined in [accounts/idAndIndex.ts:16](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api-derive/src/accounts/idAndIndex.ts#L16)*
...
*Defined in [accounts/idAndIndex.ts:31](https://github.com/polkadot-js/api/blob/4bdbacb/packages/api-derive/src/accounts/idAndIndex.ts#L31)*
