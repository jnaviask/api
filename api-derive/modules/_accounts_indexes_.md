...
*Defined in [accounts/indexes.ts:13](https://github.com/polkadot-js/api/blob/19eb484/packages/api-derive/src/accounts/indexes.ts#L13)*
...
*Defined in [accounts/indexes.ts:22](https://github.com/polkadot-js/api/blob/19eb484/packages/api-derive/src/accounts/indexes.ts#L22)*
