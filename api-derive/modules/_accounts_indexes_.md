...
*Defined in [accounts/indexes.ts:13](https://github.com/polkadot-js/api/blob/3ab5811/packages/api-derive/src/accounts/indexes.ts#L13)*
...
*Defined in [accounts/indexes.ts:32](https://github.com/polkadot-js/api/blob/3ab5811/packages/api-derive/src/accounts/indexes.ts#L32)*
