...
*Defined in [extrinsics/fromMetadata/createUnchecked.ts:19](https://github.com/polkadot-js/api/blob/9abbaab/packages/api-metadata/src/extrinsics/fromMetadata/createUnchecked.ts#L19)*
