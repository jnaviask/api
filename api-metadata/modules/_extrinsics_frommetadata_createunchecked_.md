...
*Defined in [extrinsics/fromMetadata/createUnchecked.ts:19](https://github.com/polkadot-js/api/blob/2eee6cf/packages/api-metadata/src/extrinsics/fromMetadata/createUnchecked.ts#L19)*
