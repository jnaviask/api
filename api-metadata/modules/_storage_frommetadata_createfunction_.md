...
*Defined in [storage/fromMetadata/createFunction.ts:27](https://github.com/polkadot-js/api/blob/9abbaab/packages/api-metadata/src/storage/fromMetadata/createFunction.ts#L27)*
