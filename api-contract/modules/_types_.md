...
*Defined in [types.ts:42](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L42)*
...
*Defined in [types.ts:26](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L26)*
...
*Defined in [types.ts:35](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L35)*
...
*Defined in [types.ts:31](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L31)*
...
*Defined in [types.ts:24](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L24)*
...
*Defined in [types.ts:7](https://github.com/polkadot-js/api/blob/7e5b09a/packages/api-contract/src/types.ts#L7)*
