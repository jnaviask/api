...
*Defined in [RxContract.ts:26](https://github.com/polkadot-js/api/blob/9abbaab/packages/api-contract/src/RxContract.ts#L26)*
...
*Defined in [RxContract.ts:25](https://github.com/polkadot-js/api/blob/9abbaab/packages/api-contract/src/RxContract.ts#L25)*
