...
*Defined in [RxContract.ts:26](https://github.com/polkadot-js/api/blob/5a1c79a/packages/api-contract/src/RxContract.ts#L26)*
...
*Defined in [RxContract.ts:25](https://github.com/polkadot-js/api/blob/5a1c79a/packages/api-contract/src/RxContract.ts#L25)*
