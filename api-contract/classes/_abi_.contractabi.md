...
*Defined in [Abi.ts:15](https://github.com/polkadot-js/api/blob/8ca4b5a/packages/api-contract/src/Abi.ts#L15)*
...
*Defined in [Abi.ts:13](https://github.com/polkadot-js/api/blob/8ca4b5a/packages/api-contract/src/Abi.ts#L13)*
...
*Defined in [Abi.ts:14](https://github.com/polkadot-js/api/blob/8ca4b5a/packages/api-contract/src/Abi.ts#L14)*
