...
*Defined in [RxBlueprint.ts:37](https://github.com/polkadot-js/api/blob/9b15a37/packages/api-contract/src/RxBlueprint.ts#L37)*
...
*Defined in [RxBase.ts:14](https://github.com/polkadot-js/api/blob/9b15a37/packages/api-contract/src/RxBase.ts#L14)*
...
*Defined in [RxBase.ts:16](https://github.com/polkadot-js/api/blob/9b15a37/packages/api-contract/src/RxBase.ts#L16)*
...
*Defined in [RxBase.ts:18](https://github.com/polkadot-js/api/blob/9b15a37/packages/api-contract/src/RxBase.ts#L18)*
...
*Defined in [RxBlueprint.ts:45](https://github.com/polkadot-js/api/blob/9b15a37/packages/api-contract/src/RxBlueprint.ts#L45)*
