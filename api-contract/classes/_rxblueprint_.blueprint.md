...
*Defined in [RxBlueprint.ts:37](https://github.com/polkadot-js/api/blob/01eaef2/packages/api-contract/src/RxBlueprint.ts#L37)*
...
*Defined in [RxBlueprint.ts:45](https://github.com/polkadot-js/api/blob/01eaef2/packages/api-contract/src/RxBlueprint.ts#L45)*
