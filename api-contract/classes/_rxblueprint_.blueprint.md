...
*Defined in [RxBlueprint.ts:37](https://github.com/polkadot-js/api/blob/6e42db3/packages/api-contract/src/RxBlueprint.ts#L37)*
...
*Defined in [RxBlueprint.ts:45](https://github.com/polkadot-js/api/blob/6e42db3/packages/api-contract/src/RxBlueprint.ts#L45)*
