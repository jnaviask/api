...
*Defined in [RxCode.ts:50](https://github.com/polkadot-js/api/blob/68b07eb/packages/api-contract/src/RxCode.ts#L50)*
...
*Defined in [RxCode.ts:58](https://github.com/polkadot-js/api/blob/68b07eb/packages/api-contract/src/RxCode.ts#L58)*
